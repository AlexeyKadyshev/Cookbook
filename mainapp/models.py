...
class Categories(models.Model):
    category_name = models.CharField(max_length=30, blank=True, verbose_name='Категория')
...
class Recipes(models.Model):
    category = models.ForeignKey(Categories, on_delete=models.DO_NOTHING, verbose_name='Категория')
    ...
    food_image = models.ImageField(upload_to='food_images', blank=True, verbose_name='Изображение')
